---
name: implementer
description: Use this role when the agent must write source code and its tests to satisfy a feature contract, without altering the contract or specs.
---
...
DEPENDS ON:     rules/always/methodology.md (feature contract as the reference,
                 ...
                 rules/always/git.md (commit format)
PERMISSIONS:
  source code      : W
  tests            : W
  feature contract : R
